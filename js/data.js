...
const PRODUCTS = [
  {
    ...
    shades: [
      { name: "Tiny", mood: "pink",  hex: "#FA81AF", bg: "#FE5B99", img: "assets/products/lip tint 01 tiny.png" },
      { name: "Hush", mood: "rose",  hex: "#E88799", bg: "#F9B8C6", img: "assets/products/lip tint 02 hush.png" },
      { name: "Pop",  mood: "rose",  hex: "#D58999", bg: "#F0BCC5", img: "assets/products/lip tint 03 pop.png" },
      { name: "Wink", mood: "coral", hex: "#FB9F8E", bg: "#FEA895", img: "assets/products/lip tint 04 wink.png" },
      { name: "Odd",  mood: "berry", hex: "#AE5C69", bg: "#D1858D", img: "assets/products/lip tint 05 odd.png" },
      { name: "Some", mood: "nude",  hex: "#E29C99", bg: "#FEC7C1", img: "assets/products/lip tint 06 some.png" },
    ],
  },
  {
    id: "lip-balm",
    ...
    nameKo: "멜팅 립 밤",
    img: "assets/products/lip balm 01 peach dew.png",
    price: 12000,
    rating: 4.7,
    reviewCount: 862,
    badge: null,
    ...
    shades: [
      { name: "Peach Dew",      mood: "pink",  hex: "#FAB1B9", bg: "#FEA9B2", img: "assets/products/lip balm 01 peach dew.png" },
      { name: "Cocoa Drip",     mood: "nude",  hex: "#9D6762", bg: "#73352E", img: "assets/products/lip balm 02 cocoa drip.png" },
      { name: "Tangerine Soda", mood: "coral", hex: "#FAB69F", bg: "#FEA68A", img: "assets/products/lip balm 03 tangerine soda.png" },
      { name: "Rose Jam",       mood: "rose",  hex: "#C97D8B", bg: "#E299A7", img: "assets/products/lip balm 04 rose jam.png" },
      { name: "Cherry Pop",     mood: "berry", hex: "#D44C5D", bg: "#DA3F55", img: "assets/products/lip balm 05 cherry pop.png" },
    ],
  },
  {
    id: "lip-liner",
    ...
    name: "Soft Lip Liner",
    nameKo: "소프트 립 라이너",
    img: "assets/products/lip liner 01 petal pink.png",
    price: 10000,
    rating: 4.6,
    reviewCount: 517,
    badge: null,
    ...
    shades: [
      { name: "Petal Pink",   mood: "pink",  hex: "#E197A0", bg: "#F9B8C0", img: "assets/products/lip liner 01 petal pink.png" },
      { name: "Bare Rose",    mood: "rose",  hex: "#C8979C", bg: "#E6B5BA", img: "assets/products/lip liner 02 bare rose.png" },
      { name: "Wine Berry",   mood: "berry", hex: "#A57281", bg: "#824658", img: "assets/products/lip liner 03 wine berry.png" },
      { name: "Soft Coral",   mood: "coral", hex: "#EC9786", bg: "#FCAB9B", img: "assets/products/lip liner 04 soft coral.png" },
      { name: "Toffee Brown", mood: "nude",  hex: "#D4AF9F", bg: "#F1CFBE", img: "assets/products/lip liner 05 toffee brown.png" },
    ],
  },
  {
    id: "cream-blush",
    ...
    name: "Cream Blush",
    nameKo: "크림 블러셔",
    img: "assets/products/cream blush 01 vintage rose.png",
    price: 14000,
    listPrice: 18000,
    rating: 4.9,
    reviewCount: 2041,
    ...
    pairsWith: ["lip-tint", "lip-balm"],
    shades: [
      { name: "Vintage Rose",  mood: "rose",  hex: "#D17B82", bg: "#F6BABF", img: "assets/products/cream blush 01 vintage rose.png" },
      { name: "Dusty Fig",     mood: "berry", hex: "#CA7B86", bg: "#FBBDBF", img: "assets/products/cream blush 02 dusty fig.png" },
      { name: "Pale Peach",    mood: "pink",  hex: "#ED818D", bg: "#F89FA9", img: "assets/products/cream blush 03 pale peach.png" },
      { name: "Warm Nude",     mood: "nude",  hex: "#E89584", bg: "#F8B9B3", img: "assets/products/cream blush 04 warm nude.png" },
      { name: "Coral Blossom", mood: "coral", hex: "#F88983", bg: "#FD7D74", img: "assets/products/cream blush 05 coral blossom.png" },
      { name: "Pumpkini",      mood: "coral", hex: "#F37463", bg: "#FB9387", img: "assets/products/cream blush 06 pumpkini.png" },
    ],
  },
  {
    id: "powder-blush",
    ...
    name: "Powder Blush",
    nameKo: "파우더 블러셔",
    img: "assets/products/powder blush 01 first crush.png",
    price: 16000,
    rating: 4.7,
    reviewCount: 733,
    badge: null,
    ...
    shades: [
      { name: "First Crush",    mood: "pink",  hex: "#E88484", bg: "#F39799", img: "assets/products/powder blush 01 first crush.png" },
      { name: "After School",   mood: "rose",  hex: "#D28484", bg: "#EDB0B0", img: "assets/products/powder blush 02 after school.png" },
      { name: "Sunday Morning", mood: "pink",  hex: "#EFA5B3", bg: "#F8B5C5", img: "assets/products/powder blush 03 sunday morning.png" },
      { name: "Golden Hour",    mood: "coral", hex: "#F37F6C", bg: "#FB866F", img: "assets/products/powder blush 04 golden hour.png" },
    ],
  },
];
...
const SETS = [
  {
    ...
    items: [
      { productId: "lip-tint", shade: "Wink" },
      { productId: "cream-blush", shade: "Coral Blossom" },
    ],
    discount: 0.1,
  },
  {
  ...
  },
  {
    ...
    items: [
      { productId: "lip-tint", shade: "Odd" },
      { productId: "cream-blush", shade: "Dusty Fig" },
    ],
    discount: 0.1,
  },
];
...
/* 구매후기 샘플 (데모) */
const REVIEWS = [
  { productId: "lip-tint", shade: "Wink", user: "min***", rating: 5, date: "2026.07.02",
    text: "발색 진짜 미쳤어요.. 한 번만 발라도 속부터 물든 것처럼 자연스럽고 광택이 하루종일 가요. 윙크는 웜톤 무조건 사세요!!" },
  { productId: "lip-tint", shade: "Odd", user: "you***", rating: 5, date: "2026.06.28",
    text: "오드 완전 제 인생템 됐어요ㅠㅠ 착색도 예쁘게 남고 틴트인데 안 건조해요. 재구매 각입니다." },
  { productId: "lip-tint", shade: "Hush", user: "dal***", rating: 4, date: "2026.06.21",
    text: "MLBB 찾으시면 허쉬 추천해요. 데일리로 무난하게 쓰기 좋아요. 용기가 너무 귀여워서 들고 다니는 맛이 있음ㅋㅋ" },
  { productId: "lip-balm", shade: "Peach Dew", user: "hay***", rating: 5, date: "2026.07.01",
    text: "각질 부각 하나도 없고 은은하게 혈색 돌아서 민낯에 이거 하나만 발라도 살아나요. 향도 부담스럽지 않아요." },
  { productId: "lip-balm", shade: "Rose Jam", user: "sso***", rating: 4, date: "2026.06.19",
    text: "촉촉함 오래가고 색도 생각보다 잘 올라와요. 립밤인데 틴트 바른 것 같은 느낌!" },
  { productId: "lip-liner", shade: "Toffee Brown", user: "bin***", rating: 5, date: "2026.06.25",
    text: "부드럽게 그려져서 라인 그리기 진짜 편해요. 틴트랑 톤 맞춰서 쓰니까 입술이 도톰해 보여요." },
  { productId: "cream-blush", shade: "Coral Blossom", user: "yer***", rating: 5, date: "2026.07.04",
  ...
  { productId: "cream-blush", shade: "Pumpkini", user: "sun***", rating: 4, date: "2026.06.15",
    text: "펌킨이 여름에 쓰기 딱이에요. 크림인데 마무리는 보송해서 무너짐 없어요." },
  { productId: "powder-blush", shade: "Sunday Morning", user: "eun***", rating: 5, date: "2026.06.27",
    text: "입자가 고와서 뭉침 없이 발려요. 붓으로 슥슥 발라도 실패가 없는 색이에요. 데일리 추천!" },
  { productId: "powder-blush", shade: "First Crush", user: "gae***", rating: 4, date: "2026.06.12",
